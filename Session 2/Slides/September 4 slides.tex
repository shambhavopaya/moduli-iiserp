...
\begin{frame}
\underline{\textbf{Caution:}} While using affine opens corresponding to degree $2$ element, it may seem like it should be sufficient to just invert $x^2$, and $y^2$ to get an open cover of $\P^1$. This is false!
\end{frame}
