...
\section{Sites, Sheaves, and Representable functors}
...
\begin{example}[A non-representable functor] Some moduli of curves.
\end{example}
Let $\mathcal{C}$ be a site, and $\{U_i \overset{f_i}{\to} U\}_{i\in I}$ be an element of $\text{Cov}(\mathcal{C})$. We have the fibre products for all $i,j$
\begin{center}
	\begin{tikzcd}
