...
We call the associated polynomial as the Hilbert polynomial of $M$. For a closed subscheme $X\subseteq \P_k^n$, the Hilbert polynomial of $X$ is defined to be the Hilbert polynomial of the graded module $\Gamma(X):=S/I$, where $I$ is the graded ideal of $X$.
